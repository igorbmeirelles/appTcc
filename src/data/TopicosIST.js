  ...
  <ol type="I">
    ...
    <li>
      ...
      <article>
        ...
        <br />
        Sua transmissão ocorre através de relações sexuais com pessoas infectadas,
    ...
    <li>
      ...
      <article>
        ...
        sua transmissão ocorre através da relação sexual desprotegida com uma pessoa
        infectada. <br />
        <br />
    ...
    <li>
      <strong>HPV</strong>
      <article>
        A infecção pelo <strong>HPV </strong>(Papilomavírus Humano) ocorre através do
        ...
        verrugas. <br />
        <br />
        A infecção pelo HPV pode não apresentar sintomas em muitas pessoas, sendo
        assim, pode não manifestar sinais durante meses ou anos. A diminuição da
        imunidade pode provocar a multiplicação do HPV na pessoa infectada, levando
        assim, ao surgimento das lesões.
        <figure class="d-flex  align-center flex-column">
          <img
            contain
            class="mx-auto"
    ...
    <li>
      ...
      <article>
        ...
        décadas. <br />
        <br />
        A infecção pelo HIV pode apresentar alguns sintomas como a tosse persistente,
        perda de peso, cólicas abdominais, surgimento de lesões orais, placas
        esbranquiçadas sobre a mucosa oral e o comprometimento da memória e
        concentração. <br />
        <br />
    ...
    <figure class="d-flex  align-center flex-column">
      ...
      <ul type="I" style="padding: 0px">
        ...
        <li>
          ...
          <iframe style="display: block; margin: 16px auto" src="https://www.youtube.com/embed/zW30fCnYnq8?si=q-w07RM2KEYjlgXA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          <figure class="d-flex  align-center flex-column">
            <img
              contain
              class="mx-auto"
